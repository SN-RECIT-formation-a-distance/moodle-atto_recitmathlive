  ...
  var t, e, o, n = {
      ...
      78: function(t, e, o) {
          ...
          s.Machine = function(t, e, o) {
              var n, a = t.GetArgument(e);
              try {
                  n = u.mhchemParser.toTex(a, o)
              } catch (t) {
                  throw new i.default(t[0],t[1])
              }
              t.string = n + t.string.substr(t.i),
              t.i = 0
          }
          ,
...
*/
          ...
          function n(t) {
              ...
              for (e in t)
                  for (o in t[e])
                      for (a = t[e][o].stateArray || [],
                      r = 0; r < a.length; r++) {
                          var i = t[e][o];
                          i.action_ = [].concat(i.action_);
                          for (var p = 0; p < i.action_.length; p++)
                              "string" == typeof i.action_[p] && (i.action_[p] = {
                                  type_: i.action_[p]
                              });
          ...
          var a = {
                          ...
                          if (_) {
                              for (var d = u[s].task, m = 0; m < d.action_.length; m++) {
                                  ...
                                  if (c.actions[d.action_[m].type_])
                                      h = c.actions[d.action_[m].type_](r, _.match_, d.action_[m].option);
                                  else {
                                      if (!a.actions[d.action_[m].type_])
                                          throw ["MhchemBugA", "mhchem bug A. Please report. (" + d.action_[m].type_ + ")"];
                                      h = a.actions[d.action_[m].type_](r, _.match_, d.action_[m].option)
                                  }
                                  a.concatArray(p, h)
                              }
                              if (n = d.nextState || n,
              ...
              patterns: {
                  patterns: {
                      ...
                      "^a": /^\^([0-9]+|[^\\_])/,
                      "^\\x{}{}": function(t) {
                          return a.patterns.findObserveGroups(t, "^", /^\\[a-zA-Z]+\{/, "}", "", "", "{", "}", "", !0)
                      },
                      "^\\x{}": function(t) {
                      ...
                      _9: /^_([+\-]?[0-9]+|[^\\])/,
                      "_\\x{}{}": function(t) {
                          return a.patterns.findObserveGroups(t, "_", /^\\[a-zA-Z]+\{/, "}", "", "", "{", "}", "", !0)
                      },
                      "_\\x{}": function(t) {
                      ...
                      "${(...)}$__$(...)$": function(t) {
                          return a.patterns.findObserveGroups(t, "${", "", "", "}$") || a.patterns.findObserveGroups(t, "$", "", "", "$")
                      },
                      "=<>": /^[=<>]/,
                      "#": /^[#\u2261]/,
                      "+": /^\+/,
                      ...
                      "\\color{(...)}{(...)}": function(t) {
                          return a.patterns.findObserveGroups(t, "\\color{", "", "", "}", "{", "", "", "}") || a.patterns.findObserveGroups(t, "\\color", "\\", "", /^(?=\{)/, "{", "", "", "}")
                      },
                      "\\ce{(...)}": function(t) {
                      ...
                      amount: function(t) {
                          var e;
                          if (e = t.match(/^(?:(?:(?:\([+\-]?[0-9]+\/[0-9]+\)|[+\-]?(?:[0-9]+|\$[a-z]\$|[a-z])\/[0-9]+|[+\-]?[0-9]+[.,][0-9]+|[+\-]?\.[0-9]+|[+\-]?[0-9]+)(?:[a-z](?=\s*[A-Z]))?)|[+\-]?[a-z](?=\s*[A-Z])|\+(?!\s))/))
                              return {
                                  match_: e[0],
                                  remainder: t.substr(e[0].length)
                              };
                          var o = a.patterns.findObserveGroups(t, "", "$", "$", "");
                          return o && (e = o.match_.match(/^\$(?:\(?[+\-]?(?:[0-9]*[a-z]?[+\-])?[0-9]*[a-z](?:[+\-][0-9]*[a-z]?)?\)?|\+|-)\$$/)) ? {
                              match_: e[0],
                              remainder: t.substr(e[0].length)
                          } : null
                      },
                  ...
                  findObserveGroups: function(t, e, o, n, a, r, i, p, c, u) {
                      ...
                      if (r || i) {
                          var h = this.findObserveGroups(t.substr(d.endMatchEnd), r, i, p, c);
                          if (null === h)
                              return null;
                          var l = [m, h.match_];
                          return {
                      ...
                      return {
                          match_: m,
                          remainder: t.substr(d.endMatchEnd)
                      }
                  },
                  match_: function(t, e) {
                      ...
                      if ("function" == typeof o)
                          return a.patterns.patterns[t](e);
                      var n = e.match(o);
                      return n ? n.length > 2 ? {
                          match_: n.slice(1),
              ...
              actions: {
                  ...
                  "1/2": function(t, e) {
                      var o = [];
                      e.match(/^[+\-]/) && (o.push(e.substr(0, 1)),
                      e = e.substr(1));
                      var n = e.match(/^([0-9]+|\$[a-z]\$|[a-z])\/([0-9]+)(\$[a-z]\$|[a-z])?$/);
                      return n[1] = n[1].replace(/\$/g, ""),
                      o.push({
                          type_: "frac",
                          p1: n[1],
                          p2: n[2]
                      }),
                      n[3] && (n[3] = n[3].replace(/\$/g, ""),
                      o.push({
                          type_: "tex-math",
                          p1: n[3]
                      })),
                      ...
                      actions: {
                          "o after d": function(t, e) {
                              ...
                              if ((t.d || "").match(/^[1-9][0-9]*$/)) {
                                  var n = t.d;
                                  t.d = void 0,
                                  (o = this.output(t)).push({
                                      type_: "tinySkip"
                                  }),
                                  t.b = n
                              } else
                                  o = this.output(t);
                              return a.actions["o="](t, e),
                              o
                          },
                          "d= kv": function(t, e) {
                              t.d = e,
                          ...
                          "charge or bond": function(t, e) {
                              if (t.beginsWithBond) {
                                  var o = [];
                                  return a.concatArray(o, this.output(t)),
                          ...
                          "- after o/d": function(t, e, o) {
                              var n = a.patterns.match_("orbital", t.o || "")
                                ...
                                , p = a.patterns.match_("$one lowercase latin letter$ $", t.o || "")
                                , c = "-" === e && (n && "" === n.remainder || r || i || p);
                              !c || t.a || t.b || t.p || t.d || t.q || n || !i || (t.o = "$" + t.o + "$");
                              var u = [];
                              return c ? (a.concatArray(u, this.output(t)),
                              u.push({
                                  type_: "hyphen"
                              })) : (n = a.patterns.match_("digits", t.d || ""),
                              o && n && "" === n.remainder ? (a.concatArray(u, a.actions["d="](t, e)),
                              a.concatArray(u, this.output(t))) : (a.concatArray(u, this.output(t)),
                              a.concatArray(u, a.actions.bond(t, e, "-")))),
                              u
                          },
                          "a to o": function(t) {
                              t.o = t.a,
                          ...
                          output: function(t, e, o) {
                              ...
                              if (t.r) {
                                  var r = void 0;
                                  r = "M" === t.rdt ? a.go(t.rd, "tex-math") : "T" === t.rdt ? [{
                                      type_: "text",
                                      p1: t.rd || ""
                                  }] : a.go(t.rd, "ce");
                                  var i = void 0;
                                  i = "M" === t.rqt ? a.go(t.rq, "tex-math") : "T" === t.rqt ? [{
                                      type_: "text",
                                      p1: t.rq || ""
                                  }] : a.go(t.rq, "ce"),
                                  n = {
                                  ...
                                  n = [],
                                  (t.a || t.b || t.p || t.o || t.q || t.d || o) && (t.sb && n.push({
                                      type_: "entitySkip"
                                  }),
                                  t.o || t.q || t.d || t.b || t.p || 2 === o ? t.o || t.q || t.d || !t.b && !t.p ? t.o && "kv" === t.dType && a.patterns.match_("d-oxidation$", t.d || "") ? t.dType = "oxidation" : t.o && "kv" === t.dType && !t.q && (t.dType = void 0) : (t.o = t.a,
                                  t.d = t.b,
                                  t.q = t.p,
                                  t.a = t.b = t.p = void 0) : (t.o = t.a,
                                  t.a = void 0),
                                  n.push({
                                      type_: "chemfive",
                                      a: a.go(t.a, "a"),
                              ...
                              for (var p in t)
                                  "parenthesisLevel" !== p && "beginsWithBond" !== p && delete t[p];
                              return n
                          },
                          "oxidation-output": function(t, e) {
                              var o = ["{"];
                              return a.concatArray(o, a.go(e, "oxidation")),
                              o.push("}"),
                              o
                          },
                  ...
                  pu: {
                      ...
                      actions: {
                          enumber: function(t, e) {
                              var o = [];
                              return "+-" === e[0] || "+/-" === e[0] ? o.push("\\pm ") : e[0] && o.push(e[0]),
                              e[1] && (a.concatArray(o, a.go(e[1], "pu-9,9")),
                              e[2] && (e[2].match(/[,.]/) ? a.concatArray(o, a.go(e[2], "pu-9,9")) : o.push(e[2])),
                              (e[3] || e[4]) && ("e" === e[3] || "*" === e[4] ? o.push({
                                  type_: "cdot"
                              }) : o.push({
                                  type_: "times"
                              }))),
                          ...
                          output: function(t) {
                              var e, o = a.patterns.match_("{(...)}", t.d || "");
                              o && "" === o.remainder && (t.d = o.match_);
                              var n = a.patterns.match_("{(...)}", t.q || "");
                              if (n && "" === n.remainder && (t.q = n.match_),
                              t.d && (t.d = t.d.replace(/\u00B0C|\^oC|\^{o}C/g, "{}^{\\circ}C"),
                              ...
                              t.q) {
                                  ...
                                  r.d.length > 1 || r.q.length > 1 ? e.push({
                                      type_: " / "
                                  }) : e.push({
                                      type_: "/"
                                  }),
                      ...
                      actions: {
                          ...
                          output: function(t) {
                              ...
                              if (t.rm) {
                                  ...
                                  e = o && "" === o.remainder ? a.go(o.match_, "pu") : {
                                      type_: "rm",
                                      p1: t.rm
                                  }
                              }
            ...
            , r = {
              go: function(t, e) {
                  ...
                  for (var o = "", n = !1, a = 0; a < t.length; a++) {
                      var i = t[a];
                      "string" == typeof i ? o += i : (o += r._go2(i),
              ...
              _go2: function(t) {
                  ...
                  case "chemfive":
                      ...
                      o.a && (o.a.match(/^[+\-]/) && (o.a = "{" + o.a + "}"),
                      e += o.a + "\\,"),
                      (o.b || o.p) && (e += "{\\vphantom{A}}",
                      e += "^{\\hphantom{" + (o.b || "") + "}}_{\\hphantom{" + (o.p || "") + "}}",
                      e += "\\mkern-1.5mu",
                      e += "{\\vphantom{A}}",
                      e += "^{\\smash[t]{\\vphantom{2}}\\llap{" + (o.b || "") + "}}",
                      e += "_{\\vphantom{2}\\llap{\\smash[t]{" + (o.p || "") + "}}}"),
                      o.o && (o.o.match(/^[+\-]/) && (o.o = "{" + o.o + "}"),
                      e += o.o),
                      "kv" === t.dType ? ((o.d || o.q) && (e += "{\\vphantom{A}}"),
                      o.d && (e += "^{" + o.d + "}"),
                      o.q && (e += "_{\\smash[t]{" + o.q + "}}")) : "oxidation" === t.dType ? (o.d && (e += "{\\vphantom{A}}",
                      e += "^{" + o.d + "}"),
                      o.q && (e += "{\\vphantom{A}}",
                      e += "_{\\smash[t]{" + o.q + "}}")) : (o.q && (e += "{\\vphantom{A}}",
                      e += "_{\\smash[t]{" + o.q + "}}"),
                      o.d && (e += "{\\vphantom{A}}",
                      e += "^{" + o.d + "}"));
                      break;
                  ...
                  case "roman numeral":
                      ...
                      break;
                  case "text":
                      t.p1.match(/[\^_]/) ? (t.p1 = t.p1.replace(" ", "~").replace("-", "\\text{-}"),
                      e = "\\mathrm{" + t.p1 + "}") : e = "\\text{" + t.p1 + "}";
                      break;
                  ...
                  case "arrow":
                      var i = {
                        ...
                        , p = r._getArrow(t.r);
                      i.rd || i.rq ? "<=>" === t.r || "<=>>" === t.r || "<<=>" === t.r || "<--\x3e" === t.r ? (p = "\\long" + p,
                      i.rd && (p = "\\overset{" + i.rd + "}{" + p + "}"),
                      i.rq && (p = "<--\x3e" === t.r ? "\\underset{\\lower2mu{" + i.rq + "}}{" + p + "}" : "\\underset{\\lower6mu{" + i.rq + "}}{" + p + "}"),
                      p = " {}\\mathrel{" + p + "}{} ") : (i.rq && (p += "[{" + i.rq + "}]"),
                      p = " {}\\mathrel{\\x" + (p += "{" + i.rd + "}") + "}{} ") : p = " {}\\mathrel{\\long" + p + "}{} ",
                      e = p;
                      break;
                  case "operator":
  ...
  function r(t) {
      ...
      return n[t].call(o.exports, o, o.exports, r),
      o.exports
  }
  t = r(955),
  e = r(667),
